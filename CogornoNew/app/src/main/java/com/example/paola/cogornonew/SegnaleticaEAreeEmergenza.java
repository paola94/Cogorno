...
public class SegnaleticaEAreeEmergenza extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_segnaletica_earee_emergenza);
        ...
        Fragment fragment = new SegnaleticaFragment();
    ...
    public void onBackPressed() {
        ...
        Log.d("countSegnaletica ", "vale" + count);
    ...
    public void goToMainActivity(){
        ...
        Intent intent_home = new Intent(SegnaleticaEAreeEmergenza.this, MainActivity.class);
        startActivity(intent_home);
    }

    public void goToLogin(){
        Intent intent_login = new Intent(SegnaleticaEAreeEmergenza.this, Login.class);
        startActivity(intent_login);
    }

    public void goToRegistrati(){
        Intent intent_registrati = new Intent(SegnaleticaEAreeEmergenza.this, Registrati.class);
    ...
    public void goToDatiDiBase(){
        Intent intent = new Intent(SegnaleticaEAreeEmergenza.this, DatiDiBase.class );
        startActivity(intent);
    }

    public void goToSchede(){
        Intent intent = new Intent(SegnaleticaEAreeEmergenza.this, Schede.class);
        startActivity(intent);
    }

    public void goToRisorse(){
        Intent intent = new Intent(SegnaleticaEAreeEmergenza.this, RisorseDisponibili.class);
        startActivity(intent);
    }

    public void goToSegnaletica(){
        Intent intent =  new Intent(SegnaleticaEAreeEmergenza.this, SegnaleticaEAreeEmergenza.class);
        startActivity(intent);
    }

    public void goToScenari(){
        Intent intent =  new Intent(SegnaleticaEAreeEmergenza.this, ScenariEModelli.class);
        startActivity(intent);
    }

    public void goToEmail(){
        Intent intent = new Intent(SegnaleticaEAreeEmergenza.this, Email.class);
        startActivity(intent);
    }
