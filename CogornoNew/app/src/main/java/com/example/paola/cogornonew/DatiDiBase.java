...
public class DatiDiBase extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dati_di_base);
        ...
        Fragment fragment = new DatiDiBaseFragment();
    ...
    public void goToMainActivity(){
        ...
        Intent intent_home = new Intent(DatiDiBase.this, MainActivity.class);
        startActivity(intent_home);
    }

    public void goToLogin(){
        Intent intent_login = new Intent(DatiDiBase.this, Login.class);
        startActivity(intent_login);
    }

    public void goToRegistrati(){
        Intent intent_registrati = new Intent(DatiDiBase.this, Registrati.class);
    ...
    public void goToDatiDiBase(){
        Intent intent = new Intent(DatiDiBase.this, DatiDiBase.class );
        startActivity(intent);
    }

    public void goToSchede(){
        Intent intent = new Intent(DatiDiBase.this, Schede.class);
        startActivity(intent);
    }

    public void goToRisorse(){
        Intent intent = new Intent(DatiDiBase.this, RisorseDisponibili.class);
        startActivity(intent);
    }

    public void goToSegnaletica(){
        Intent intent =  new Intent(DatiDiBase.this, SegnaleticaEAreeEmergenza.class);
        startActivity(intent);
    }

    public void goToScenari(){
        Intent intent =  new Intent(DatiDiBase.this, ScenariEModelli.class);
        startActivity(intent);
    }

    public void goToEmail(){
        Intent intent = new Intent(DatiDiBase.this, Email.class);
        startActivity(intent);
    }
