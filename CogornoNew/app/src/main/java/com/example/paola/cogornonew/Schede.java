...
public class Schede extends AppCompatActivity
    ...
    public void goToLogin(){
        Intent intent_login = new Intent(Schede.this, Login.class);
        startActivity(intent_login);
    }

    public void goToRegistrati(){
        Intent intent_registrati = new Intent(Schede.this, Registrati.class);
    ...
    public void goToDatiDiBase(){
        Intent intent = new Intent(Schede.this, DatiDiBase.class);
        startActivity(intent);
    }

    public void goToSchede(){
        Intent intent = new Intent(Schede.this, Schede.class);
        startActivity(intent);
    }

    public void goToRisorse(){
        Intent intent = new Intent(Schede.this, RisorseDisponibili.class);
        startActivity(intent);
    }

    public void goToSegnaletica(){
        Intent intent =  new Intent(Schede.this, SegnaleticaEAreeEmergenza.class);
        startActivity(intent);
    }

    public void goToScenari(){
        Intent intent =  new Intent(Schede.this, ScenariEModelli.class);
        startActivity(intent);
    }

    public void goToEmail(){
        Intent intent = new Intent(Schede.this, Email.class);
        startActivity(intent);
    }
