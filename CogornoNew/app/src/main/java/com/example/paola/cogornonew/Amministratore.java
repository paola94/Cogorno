...
public class Amministratore extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment fragment = new PaginaAmministratore();
    ...
    public void goToMainActivity(){
        ...
        Intent intent_home = new Intent(Amministratore.this, MainActivity.class);
        startActivity(intent_home);
    }

    public void goToLogin(){
        Intent intent_login = new Intent(Amministratore.this, Login.class);
        startActivity(intent_login);
    }

    public void goToRegistrati(){
        Intent intent_registrati = new Intent(Amministratore.this, Registrati.class);
    ...
    public void goToDatiDiBase(){
        Intent intent = new Intent(Amministratore.this, DatiDiBase.class );
        startActivity(intent);
    }

    public void goToSchede(){
        Intent intent = new Intent(Amministratore.this, Schede.class);
        startActivity(intent);
    }

    public void goToRisorse(){
        Intent intent = new Intent(Amministratore.this, RisorseDisponibili.class);
        startActivity(intent);
    }

    public void goToSegnaletica(){
        Intent intent =  new Intent(Amministratore.this, SegnaleticaEAreeEmergenza.class);
        startActivity(intent);
    }

    public void goToScenari(){
        Intent intent =  new Intent(Amministratore.this, ScenariEModelli.class);
        startActivity(intent);
    }

    public void goToEmail(){
        Intent intent = new Intent(Amministratore.this, Email.class);
        startActivity(intent);
    }
