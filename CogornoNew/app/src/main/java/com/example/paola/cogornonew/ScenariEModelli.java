...
public class ScenariEModelli extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scenari_emodelli);
    ...
    public void goToMainActivity(){
        ...
        Intent intent_home = new Intent(ScenariEModelli.this, MainActivity.class);
        startActivity(intent_home);
    }

    public void goToLogin(){
        Intent intent_login = new Intent(ScenariEModelli.this, Login.class);
        startActivity(intent_login);
    }

    public void goToRegistrati(){
        Intent intent_registrati = new Intent(ScenariEModelli.this, Registrati.class);
    ...
    public void goToDatiDiBase(){
        Intent intent = new Intent(ScenariEModelli.this, DatiDiBase.class );
        startActivity(intent);
    }

    public void goToSchede(){
        Intent intent = new Intent(ScenariEModelli.this, Schede.class);
        startActivity(intent);
    }

    public void goToRisorse(){
        Intent intent = new Intent(ScenariEModelli.this, RisorseDisponibili.class);
        startActivity(intent);
    }

    public void goToSegnaletica(){
        Intent intent =  new Intent(ScenariEModelli.this, SegnaleticaEAreeEmergenza.class);
        startActivity(intent);
    }

    public void goToScenari(){
        Intent intent =  new Intent(ScenariEModelli.this, ScenariEModelli.class);
        startActivity(intent);
    }

    public void goToEmail(){
        Intent intent = new Intent(ScenariEModelli.this, Email.class);
        startActivity(intent);
    }
